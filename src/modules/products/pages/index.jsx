...
const ProductList = () => {
  ...
  const deleteProduct = (idToDelete) => {
    ...
    axiosInstance.delete(`/product/${idToDelete}`)
      .then((res) => {
        console.log("world")
              ...
              <tr key={ele._id}>
                ...
                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                  <div className="flex items-center space-x-3.5">
                    ...
                    <button onClick={() => navigate("/product/view/" + ele._id)} className="hover:text-primary">
                      <svg
                    ...
                    <button onClick={() => deleteProduct(ele._id)} className="hover:text-primary">
                      <svg
                        className="fill-current"
                        width="18"
                        height="18"
                    ...
                    <button onClick={() => navigate("/product/update/" + ele._id)} className="hover:text-primary">
                      <svg
                        className="fill-current"
                        width="18"
                        height="18"
